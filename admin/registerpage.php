...
$string2="0123456789";
 ...
 $middle=ucfirst(strtolower($_POST['middlename']));
        ...
        if($count==0)
        {
          mysqli_query($db,"INSERT INTO `admin` VALUES('$_POST[firstname]','$_POST[middlename]','$_POST[lastname]','$_POST[eid]','$_POST[mobilenumber]','$_POST[email]','$username','$password','user.jpg');");
        ?>
