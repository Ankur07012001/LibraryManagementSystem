    ...
    <div class="container-fluid">
        ...
        <div class="box">
            <div style="text-align: center;">
                <img src="image\signup.jpg" alt="" class="user">
            </div>
            <h3>SIGN UP</h3>
            <form class="form-horizontal" method="POST">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <input type="text" class="form-control" id="prn" placeholder="Enter prn" name="PRN" required>
                    </div>
                </div>
...
if(isset($_POST['signup']))
{
 ...
 if($count==0)
  {
   mysqli_query($db,"INSERT INTO `STUDENT` VALUES('$_POST[firstname]','$_POST[middlename]','$_POST[lastname]','$_POST[PRN]','$_POST[mobilenumber]','$_POST[email]','$username','$password','user.jpg');");
...
$mail->SMTPAuth   = true;                                   
$mail->Username   = 'librarymanagment2020@gmail.com';                     
$mail->Password   = 'library308';                             
$mail->SMTPSecure = 'tls';         
$mail->Port       = 587;                                    
...
<div style="text-align: center;">
  <img src="https://freepngimg.com/thumb/book/13-books-png-image-with-transparency-background.png" style="height:auto; width:200px;"  alt="">
