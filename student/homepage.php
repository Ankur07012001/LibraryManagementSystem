...
?>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark  " style=" padding-top: 0px;padding-bottom:0px;">
        ...
        <a href="#" class="navbar-brand">
            <img src="image\Book.jpg" width="30" height="30" class="d-inline-block align-top" alt="">
            LIBRARY</a>
    ...
    <footer class="page-footer font-small  pt-4" style="background-color:#161819;" id="footer">
