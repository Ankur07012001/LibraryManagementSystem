...
<div class="box"  >
  ...
  <form class="form-horizontal" method="POST" >
    <div class="form-group">
      <p>
        <div class="col-sm-12">
          <input type="text" class="form-control"  placeholder="Enter username"  name="usern" required>
        </div>
      </p>
    ...
    <div class="col-sm-offset-3   col-sm-6">
      <p>
        <button type="submit"    class="btn btn-default btn-block"  name="submit" style="border-radius:10px;">SUBMIT</button>
      </p>
...
$q=mysqli_query($db,"SELECT * FROM admin WHERE username='$_POST[usern]' && email='$_POST[email]';");
...
$sql= "UPDATE admin SET  password='$newpassword'  WHERE username='$_POST[usern]' && email='$_POST[email]';";
