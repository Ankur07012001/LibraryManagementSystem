...
<body>
    ...
    {
    $count=0;
    $res=mysqli_query($db,"SELECT * FROM `student` WHERE username='$_POST[usern]' && password='$_POST[pwd]';");
    ...
    <?php
     ...
     session_id('student');
     session_start();
     $_SESSION['login_suser'] = $row['username'];
     $_SESSION['login_spassword']=$row['password'];
