...
?>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark  " style="padding-top: 0px;padding-bottom:0px;">
        ...
        <a href="#" class="navbar-brand"> <img src="image\Book.jpg" width="30" height="30" class="d-inline-block align-top" alt="">
        LIBRARY</a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="bookrequest.php">Books Request</a>
                </li>
...
{
  $sql="INSERT INTO `comments` VALUES('','$first','$middle','$_SESSION[login_suser]', '$_POST[search]');";
  if(mysqli_query($db,$sql))
  {
    ...
    ?>
                    <script type="text/javascript">
                        ...
                        element.innerHTML = "Thankyou for your comment";
...
while ($row=mysqli_fetch_assoc($res)) 
{
  ...
  if($row['username']==$_SESSION['login_suser'])
 {
  echo "<tr class='table-success'>";
  echo "<td>"; echo "".$row['first']."".$row['last']; echo "</td>";
