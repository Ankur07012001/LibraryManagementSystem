...
$res=mysqli_query($db,"SELECT * FROM `admin` WHERE username='$_SESSION[login_auser]';");
    ...
    <div class="container-fluid">
        ...
        <div class="box">
            ...
            <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-4" for="eid">EID:</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="eid" placeholder="Enter prn" name="eid"
                            value="<?php echo $eid;?>" required>
                    </div>
                </div>
...
if(isset($_POST['updateprofile']))
{
    ...
    {
        $sql1= "UPDATE admin SET  first='$first',middle='$middle', last='$last',eid='$eid',mobilenumber='$mobileno',email='$email'  WHERE username='$_SESSION[login_auser]' && password='$_SESSION[login_apassword]';";
    ...
    else
    {
		...
		echo $photo;
        $sql1= "UPDATE admin SET  first='$first',middle='$middle', last='$last',eid='$eid',mobilenumber='$mobileno',email='$email',image='$photo' WHERE username='$_SESSION[login_auser]' && password='$_SESSION[login_apassword]';";
